...
const CardBody = () => {
	return (
		<div className={styles.cardBody}>
			...
			<Row type="row" customStyle={{ justifyContent: "space-between", alignItems: "center", padding: "0 1rem" }}>
				<Button customStyle={{ backgroundColor: "transparent" }}>
					<Heading type="h5" customStyle={{ color: "#000" }}>
						100 seats remaining
					</Heading>
				</Button>
				<Button customStyle={{ backgroundColor: "transparent" }}>
					<Heading type="h5" customStyle={{ color: "#FD7E14" }}>
						Partially Refundable
					</Heading>
				</Button>
				<Button customStyle={{ backgroundColor: "transparent" }}>
					<Heading type="h5" customStyle={{ color: "#482A89" }}>
						View flight details
					</Heading>
				</Button>
			</Row>
...
function TextContainer() {
	return (
		<Row type="col" customClassName="textContainer" customStyle={{ rowGap: "1rem" }}>
			<Heading type="h4">Sun, 29 Jan 2023</Heading>
			<Heading type="h3" customStyle={{ marginTop: "0.6rem" }}>
				14.50
			</Heading>
			<Heading type="h4" customStyle={{ width: "75%" }}>
				Moi Intl, Mombasa Kenya
			</Heading>
		</Row>
	);
}
	...
	return (
		<Row type="center">
			...
			<div className={styles.timeContainer}>
				<Heading type="h6">9hr 50min</Heading>
			</div>
...
function PriceContainer() {
	return (
		<Row type="col" customStyle={{ padding: "1rem 3rem" }}>
			<Heading type="h2">$18,500</Heading>
